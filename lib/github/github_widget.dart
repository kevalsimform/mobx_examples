...
class GithubExampleState extends State<GithubExample> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: Column(
        children: <Widget>[UserInput(store), ShowError(store), LoadingIndicator(store), RepositoryListView(store)],
      ));
}
...
class LoadingIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      Observer(builder: (_) => store.fetchReposFuture.status == FutureStatus.pending ? const LinearProgressIndicator() : Container());
}
